...
namespace CGD.Combat
{
    ...
    public class ShapeHitEvent : IActionEvent
    {
        ...
        private void TickSphere(ActionContext ctx, Vector3 origin, Vector3 forward)
        {
            ...
            if (ctx.DebugDraw)
                DebugDrawSphere(center, _radius, Color.cyan, ctx.DebugDuration);
        }
        ...
        private void TickBox(ActionContext ctx, Vector3 origin, Vector3 forward)
        {
            ...
            if (ctx.DebugDraw)
                DebugDrawBox(center, _halfExtents, orientation, Color.green, ctx.DebugDuration);
        }
        ...
        private static void DebugDrawBox(Vector3 center, Vector3 half, Quaternion rot,
